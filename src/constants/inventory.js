...
console.log("Deel 2 - Oefenen met array methodes - Opdracht 1b: ", soldOutTvs);

// Opdracht 1c: Gebruik een array-methode om de informatie van het tv-type 'NH3216SMART' op te halen.

let smartTv = inventory.find((smartTv) => {
  return smartTv.type === "NH3216SMART";
});

console.log("Deel 2 - Oefenen met array methodes - Opdracht 1c: ", smartTv);
...
let suitableTvsForSport = inventory.map((suitableTvForSport) => {
  return {
    name: `${suitableTvForSport.brand} ${suitableTvForSport.name}`,
    suitable: suitableTvForSport.refreshRate >= 100,
  };
});

console.log(
  "Deel 2 - Oefenen met array methodes - Opdracht 1d: ",
  suitableTvsForSport,
);
...
let bigScreenTvsOf65InchAndHigher = inventory.filter(
  (bigScreenTvOf65InchAndHigher) => {
    return bigScreenTvOf65InchAndHigher.availableSizes.some(
      (size) => size >= 65,
    );
  },
);
...
console.log(
  "Deel 2 - Oefenen met array methodes - Opdracht 1e (uitdaging): ",
  bigScreenTvsOf65InchAndHigher,
);
...
let tvsWithAmbilight = inventory.filter((tvWithAmbilight) => {
  return tvWithAmbilight.options.find(
    (option) => option.name === "ambiLight" && option.applicable === true,
  );
});

console.log(
  "Deel 2 - Oefenen met array methodes - Opdracht 1f (uitdaging): ",
  tvsWithAmbilight,
);
